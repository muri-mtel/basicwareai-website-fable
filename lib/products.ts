...
export const PRODUCTS: Product[] = [
  {
    ...
    heroImageSrc: "/assets/2_practice_01.png",
    heroColor: "#0148ae",
      ...
      features: [
        {
          title: "一次接入，覆盖全部模型",
          description:
            "一次接入即可访问全球 10+ 顶尖 AI 模型，无需逐一签约、集成或完成繁琐的供应商入驻流程。",
        },
        {
          title: "切换模型，无需改动代码",
          description:
  ...
  },
  {
    ...
    brandName: "OpenClaw",
    heroImageSrc: "/assets/2_practice_02.png",
    heroColor: "#0c2340",
  ...
  },
  {
    ...
    heroImageSrc: "/assets/2_practice_03.png",
    heroColor: "#0d2b1d",
    ...
    zh: {
      ...
      features: [
        ...
        },
        {
          title: "数字人视频播报",
          description:
            "部署能够「开口说话」的虚拟主播。多语言数字人大规模产出视频内容，无需摄影棚，无需出镜费用。",
        },
        {
  ...
  },
  {
    ...
    heroImageSrc: "/assets/2_practice_04.png",
    heroColor: "#1c0a3d",
